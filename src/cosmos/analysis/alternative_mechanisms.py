...
def main():
    ...
    for age in [1, 2, 3, 4, 5]:
        ...
        print(f"{age:9} | {r['rho_c']:11.2e} | {r['rho_DDT']:13.2e} | "
    ...
    for age in [1, 2, 3, 4, 5]:
        ...
        print(f"{age:9} | {r['v_conv']:13.1f} | {r['r_ignition']:10.1f} | "
    ...
    for Z in [0.1, 0.3, 1.0, 3.0]:
        ...
        print(f"{Z:8.1f} | {r['CO_ratio']:9.3f} | {r['X_22Ne']:7.4f} | "
    ...
    for age in [1, 2, 3, 4, 5]:
        ...
        print(f"{age:9} | {r['t_simmer']:13.1e} | {r['delta_Ye']:+7.5f} | "
              f"{r['M_Ni']:9.3f} | {r['delta_mag']:+.3f}")
    ...
    for age in [1, 2, 3, 4, 5]:
        ...
        print(f"{age:9} | {r['DDT_effect']:+.3f} | {r['geometry_effect']:+.3f}  | "
    ...
    np.savez('data/processed/alternative_mechanisms.npz',
             ages=ages,
