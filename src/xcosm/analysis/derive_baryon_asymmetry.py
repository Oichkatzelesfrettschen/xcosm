...
def electroweak_baryogenesis():
    ...
    print("\n  Jarlskog invariant:")
    print("    J ≈ |V_us||V_cb||V_ub| sin(δ_CP)")
...
def leptogenesis_j3o():
    ...
    print("    1/√7 = cos(δ_CP) relates to Fano plane")
    print("    √(6/7) = sin(δ_CP) = effective CP asymmetry")
...
def direct_j3o_formula():
    ...
    print("    η/[(1/√7)^24] ≈ 10")
    print("    10 ≈ 7 + 3 (imaginary octonions + generations)")
    print("    OR 10 = number of SM gauge generators (3+2+1 + 4?)")
