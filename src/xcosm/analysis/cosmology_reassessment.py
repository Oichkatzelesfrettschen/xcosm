...
def main():
    ...
    for gamma in [0.0, 0.01, 0.015, 0.02, 0.025, 0.03]:
        ...
        print(
            f"{beta_converged:8.3f} | {gamma:7.3f} | {w0_app:13.3f} | {wa_app:13.3f} | {sigma:11.2f}{marker}"
        )
    ...
    print("     Converged value: β = 0.008 (from 128³)")
    print("     Contribution: δμ ~ 0.02 mag (INSUFFICIENT alone)")
    print()
    print("  2. PROGENITOR AGE (γ):")
    print("     Required: γ ≥ 0.02")
    print("     Physical basis: Son et al. 2025 (5σ age-luminosity)")
    print("     Contribution: δμ ~ 0.03-0.05 mag")
    print()
    print("  3. HYBRID MODEL:")
    print("     β = 0.008 (metallicity, from simulations)")
    print("     γ = 0.02 (age, from observations)")
    ...
    # Save results
    np.savez(
        "data/processed/cosmology_reassessment.npz",
