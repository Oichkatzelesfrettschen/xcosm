...
% Figure placeholder - generate with hypothesis_matrix.py
\begin{figure}[h]
\centering
\fbox{\parbox{0.85\textwidth}{\centering\vspace{2cm}
\textbf{[Hypothesis Dependency Graph]}\\[0.5em]
\small Generate with: \texttt{python papers/umbrella-note/code/hypothesis\_matrix.py}
\vspace{2cm}}}
\caption{XCOSM hypothesis dependency graph. \textcolor{red}{Red nodes} are calibrated (not predictions). \textcolor{green}{Green nodes} are independent inputs. \textcolor{orange}{Orange nodes} are testable predictions. Most dependencies flow through calibrated parameters, not independent inputs.}
...
\input{tables/falsified_hypotheses.tex}
...
% Include table from falsification_table.py
\input{tables/pending_tests.tex}
