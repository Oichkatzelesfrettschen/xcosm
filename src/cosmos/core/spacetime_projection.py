...
from cosmos.core.octonion_algebra import Octonion, Jordan3O, FANO_LINES
...
def verify_minkowski_signature():
    ...
    for i in range(4):
        for j in range(4):
            ...
            d2_det = (h_pp.determinant() - h_pm.determinant()
                     - h_mp.determinant() + h_mm.determinant()) / (4 * eps**2)
