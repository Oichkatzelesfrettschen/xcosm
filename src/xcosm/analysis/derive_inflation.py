...
def f4_potential():
    ...
    print(f"    ε = {eps:.4f}")
    print(f"    η = {eta:.4f}")
    print("    Slow-roll requires ε, |η| << 1")
...
def dimensional_transmutation():
    ...
    # Number of e-folds
    print("\n  E-fold connection:")
    print("    N_e = 60 ≈ 2 × 27 + 6 = 2 × dim(J₃(O)) + dim(kernel)")
...
def spectral_index():
    ...
    print("    r ~ 16ε ~ 16/N_e² × (M_P/M)²")
    print(f"    For M = M_P/√27: r ~ {r_pred:.4f}")
    print("    Observational bound: r < 0.06")
