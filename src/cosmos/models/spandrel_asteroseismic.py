...
ULTRA_MASSIVE_WD_DATABASE = [
    ...
    UltraMassiveWD(
        ...
        distance_pc=28.7,
        T_eff_K=12340,
        periods_s=[170.0, 175.0, 183.0, 186.0, 195.0, 201.0,
                  209.0, 218.0, 225.0, 234.0, 245.0, 252.0, 258.0],
    ...
    UltraMassiveWD(
        ...
        T_eff_K=12400,
        periods_s=[137.0, 141.0, 151.0, 164.0, 180.0, 195.0,
                  210.0, 225.0, 240.0, 255.0, 270.0, 350.0,
                  450.0, 600.0, 800.0, 950.0, 1100.0, 1250.0, 1345.0],
    ...
    def priority_targets(self) -> List[Dict]:
        ...
        for wd in self.database:
            ...
            priorities.append({
                ...
                'reason': self._priority_reason(wd)
            })
...
def demonstrate_asteroseismic_predictions():
    ...
    for pred in predictions:
        print(f"{pred['wd_name']:<30} | {pred['predicted_D']:>5.2f} | "
