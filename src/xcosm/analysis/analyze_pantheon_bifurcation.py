...
def analyze_bifurcation(df, z_max=0.1):
    ...
    print("=" * 80)
    print(f"POPULATION STATISTICS (z ≤ {z_max})")
    print("=" * 80)
    print()
    ...
    print(
        f"  Mean μ: {df_low_d['distance_modulus'].mean():.4f} ± {df_low_d['distance_modulus'].std():.4f}"
    )
    ...
    print(
        f"  Mean μ: {df_high_d['distance_modulus'].mean():.4f} ± {df_high_d['distance_modulus'].std():.4f}"
    )
    ...
    print(
        f"  Mean x₁: {df_all_low_d['x1_stretch'].mean():.4f} ± {df_all_low_d['x1_stretch'].std():.4f}"
    )
    print(f"  Mean z: {df_all_low_d['redshift'].mean():.4f} ± {df_all_low_d['redshift'].std():.4f}")
    print(
        f"  Mean μ: {df_all_low_d['distance_modulus'].mean():.4f} ± {df_all_low_d['distance_modulus'].std():.4f}"
    )
    print()
    ...
    print(
        f"  Mean x₁: {df_all_high_d['x1_stretch'].mean():.4f} ± {df_all_high_d['x1_stretch'].std():.4f}"
    )
    print(
        f"  Mean z: {df_all_high_d['redshift'].mean():.4f} ± {df_all_high_d['redshift'].std():.4f}"
    )
    print(
        f"  Mean μ: {df_all_high_d['distance_modulus'].mean():.4f} ± {df_all_high_d['distance_modulus'].std():.4f}"
    )
    print()
...
def main():
    ...
    try:
        ...
        print("Error: Pantheon+SH0ES.dat not found in data/raw/")
