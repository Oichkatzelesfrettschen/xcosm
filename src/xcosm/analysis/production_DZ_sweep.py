...
PILOT_D_VALUES = {0.1: 2.81, 0.3: 2.78, 0.5: 2.76, 1.0: 2.73, 2.0: 2.70, 3.0: 2.67}
...
def main():
    ...
    print("  Pilot (48³):      D_ref = 2.73, β = 0.05")
    ...
    print("  This drives the D(z) evolution → phantom-like signal")
    print()

    # TODO: Save results once grid variables are computed
